    ...
    public void getКandomProductFromList() throws InterruptedException, UnsupportedEncodingException {
        ...
        if (element.size() > 0 && element.get(0).isDisplayed()) {
           ...
           /* {"ok":true,"result":[{"update_id":43242962,
                    ...
                    "message":{"message_id":20,"from":{"id":589206396,"is_bot":false,"first_name":"Ksenia","username":"ksenia_levchuk","language_code":"uk"},"chat":{"id":589206396,"first_name":"Ksenia","username":"ksenia_levchuk","type":"private"},"date":1728161347,"text":"Hey"}}]}
*/
        }
    }
